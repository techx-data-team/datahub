...
import PropertiesEditableTable, { PropertyDataType } from './PropertiesEditableTable';
...
export default function PropertyEditModal(props: Props) {
    const { onClose } = props;
    ...
    return (
        ...
        >
            <PropertiesEditableTable dataSource={dataSource} setDataSource={setDataSource} />
        </Modal>
    );
}
